...
const CLIENTS = [
  { name: "Grand Seiko", src: "/LandingPage/logo-entreprises/Grand_Seiko_Logo.svg" },
  { name: "Cegedim", src: "/LandingPage/logo-entreprises/cegedim-logo-HD.jpg" },
  { name: "Pennylane", src: "/LandingPage/logo-entreprises/logo-pennylane.png" },
  { name: "Cerballiance", src: "/LandingPage/logo-entreprises/cerballiancelogo.png" },
  { name: "Parnasse", src: "/LandingPage/logo-entreprises/parnasse.png" },
  { name: "Zefir", src: "/LandingPage/logo-entreprises/zefirlogo.png" },
  { name: "Avril", src: "/LandingPage/logo-entreprises/avrillogo.jpg" },
  { name: "Arkéa Financement", src: "/LandingPage/logo-entreprises/logoarkea.jpg" },
];

// Logos du badge hero (petites icônes) + données du mini-tableau "Par moteur d'IA".
const HERO_BADGE_LOGOS = ["/google.svg", "/chatgpt.png", "/gemini.png", "/perplexity.png"];
...
const HERO_PILLARS: HeroPillar[] = [
  {
    ...
    type: "engines",
    rows: [
      { logo: "/chatgpt.png", label: "ChatGPT", cit: 48, pages: 31 },
      { logo: "/google.svg", label: "Google Mode IA", cit: 42, pages: 27 },
      { logo: "/gemini.png", label: "Gemini", cit: 35, pages: 22 },
      { logo: "/perplexity.png", label: "Perplexity", cit: 29, pages: 18 },
      { logo: "/copilot.svg", label: "Copilot", cit: 19, pages: 12 },
    ],
  },
  {
    key: "autorite",
...
const VALUE_CARDS = [
  {
    ...
    img: "/LandingPage/visibilitéIA.png",
  ...
  },
  {
    ...
    img: "/LandingPage/comparaisonConcurrentielle.png",
  ...
  },
  {
    ...
    img: "/LandingPage/recommandationsstrategiques.png",
...
const BENTO = [
  { title: "Visibilité IA", desc: "Votre présence dans les réponses des IA : ChatGPT, Google AI Overview, Gemini et Perplexity.", img: "/LandingPage/img-bento-geo.png", featured: true },
  { title: "Technique", desc: "L'état de santé technique de votre site : indexation, Core Web Vitals, performance et structure des pages.", img: "/LandingPage/img-bento-tech.png", featured: false },
  { title: "Sémantique", desc: "La pertinence de vos contenus : couverture des intentions de recherche et autorité sur vos thématiques.", img: "/LandingPage/img-bento-semantique.png", featured: false },
  { title: "Autorité", desc: "Le poids de votre marque : netlinking, popularité, recherche de marque et e-réputation.", img: "/LandingPage/img-bento-autorite.png", featured: false },
  { title: "Marché", desc: "Votre position face aux concurrents : parts de visibilité, benchmark et opportunités à saisir.", img: "/LandingPage/img-bento-marche.png", featured: false },
  { title: "Plan d'action", desc: "Ce qu'il faut faire, et dans quel ordre : quick wins, priorités et impact estimé.", img: "/LandingPage/img-bento-plandaction.png", featured: false },
];
    ...
    return (
      ...
      >
        ...
        <video autoPlay muted loop playsInline className="pointer-events-none absolute inset-0 h-full w-full object-cover">
          <source src="/LandingPage/Background_bento_GEO.mp4" type="video/mp4" />
        </video>
...
export default function LandingPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!url.trim()) return;
    if (canGenerate) setShowOnboarding(true);
      ...
      <main className="relative z-[3] flex flex-1 flex-col">
        ...
        <section className="px-6 py-20 md:py-28">
          ...
          <Reveal className="relative mx-auto mt-12 flex max-w-[1120px] items-end justify-center overflow-hidden rounded-[32px] border border-[#4f406d]/[0.12] px-8 pt-10 md:px-16 md:pt-16">
            <img src="/LandingPage/background-outils-techs.jpg" alt="" className="absolute inset-0 h-full w-full object-cover" />
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-[1fr_5rem_5rem] items-center border-b border-border-subtle py-5 sm:grid-cols-[1fr_10rem_10rem]">
                ...
                <span className="flex items-center justify-center gap-2 text-[15px] font-semibold text-text-heading sm:text-[17px]">
                  <img src="/faviconGSI.svg" alt="" className="h-6 w-6 rounded-md" />
                  GSI
                </span>
        ...
        <section className="px-6 py-16 md:py-20">
          <Reveal className="relative mx-auto max-w-[1120px] overflow-hidden rounded-[32px] bg-neutral-950">
            <img src="/LandingPage/img-bg-woman-divcta.jpg" alt="" className="absolute inset-0 h-full w-full object-cover" />
            ...
            <img
              src="/LandingPage/img-div-cta.png"
