...
// Contenu ÉDUCATIF statique porté verbatim de la maquette de Barthélemy
// (feat/demo-front-juin) : « comment est calculé chaque score ». Ce n'est PAS de
// la donnée projet — c'est du contenu de la bulle « i » (ScoreInfoModal),
// identique quel que soit le score réel. Source de vérité design = Barth.
...
export interface ScoreInfoContent {
  title: string;
  heading: string;
  intro: string;
  criteria: { label: string; description: string; icon: ReactNode }[];
  conclusion: string;
}

export const scoreInfos: Record<
  "technique" | "semantique" | "geo" | "autorite",
  ScoreInfoContent
> = {
  technique: {
    title: "SEO Technique",
    ...
    intro:
      "Le score SEO technique mesure la capacité de votre site à être exploré, indexé et correctement interprété par les moteurs de recherche.",
    criteria: [
    ...
    conclusion:
      "Ce score reflète la santé technique globale de votre site et son potentiel d'indexation.",
  },
  semantique: {
    title: "SEO Sémantique",
    heading: "Comment est calculé le score sémantique ?",
    intro:
      "Le score sémantique mesure votre capacité à vous positionner sur des mots-clés stratégiques face à vos concurrents.",
    criteria: [
    ...
    conclusion:
      "Ce score reflète votre compétitivité SEO sur les requêtes qui comptent vraiment pour votre business.",
  },
  geo: {
    title: "GEO",
    heading: "Comment est calculé le score GEO ?",
    intro:
      "Le score GEO mesure la capacité d'une page à être comprise, extraite et citée par les moteurs d'IA générative (ChatGPT, Perplexity, Google AI Overviews).",
    criteria: [
    ...
    conclusion:
      "Optimiser ces éléments améliore votre visibilité dans les réponses générées par l'IA.",
  },
  autorite: {
    title: "Autorité",
    heading: "Comment est calculé le score d'autorité ?",
    intro:
      "Le score d'autorité mesure la crédibilité et la popularité de votre site dans l'écosystème web.",
    criteria: [
    ...
    conclusion:
      "Ce score reflète le niveau de confiance que les moteurs de recherche accordent à votre site.",
  },
};

// Icônes par score (en-tête de carte) — reprises verbatim de la maquette.
export const scoreIcons: Record<"technique" | "semantique" | "autorite", ReactNode> = {
  technique: (
    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
