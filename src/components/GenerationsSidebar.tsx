...
export default function GenerationsSidebar() {
  const { selected, setSelectedId, all: generations, collapsed, toggleCollapsed, search, setSearch } = useGeneration();
  ...
  // La recherche est faite SERVEUR (provider, ?search= ILIKE) : `generations` est
  // déjà la liste filtrée. Plus de filtre local qui ne voyait que les 30 chargés.
